...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MAGIC_BRICKS = registerBlock("magic_bricks",
            () -> new MagicBrickBlock(BlockBehaviour.Properties.copy(Blocks.BRICKS).isViewBlocking((something1, something2, something3) -> false).isSuffocating((something1, something2, something3) -> false)));
