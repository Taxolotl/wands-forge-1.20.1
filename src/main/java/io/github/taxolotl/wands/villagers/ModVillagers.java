package io.github.taxolotl.wands.villagers;
...
public class ModVillagers {
    ...
    public static final RegistryObject<PoiType> WANDMAKER_POI = POI_TYPES.register("wandmaker_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.WAND_CRAFTING_STATION.get().getStateDefinition().getPossibleStates()),
                    2, 2));
    ...
    public static final RegistryObject<VillagerProfession> WANDMAKER =
            VILLAGER_PROFESSIONS.register("wandmaker", () -> new VillagerProfession("wandmaker",
                    holder -> holder.get() == WANDMAKER_POI.get(), holder -> holder.get() == WANDMAKER_POI.get(),
